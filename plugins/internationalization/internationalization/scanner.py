...
from internationalization.core.impl.extract_dust import extract_dust
...
METHOD_MAP = [('**.py', 'python'), ('**.js', 'javascript'), ('**.html', 'javascript'), ('**.dust', 'dust')]
# A list of ``(pattern, method)`` tuples that maps of extraction method names to extended global patterns
METHOD_EXTRACTOR = {'ignore': extract_nothing, 'python': extract_python, 'javascript': extract_javascript, 'dust': extract_dust}
